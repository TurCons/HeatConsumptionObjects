...
module.exports = function(environment) {
  ...
  var authenticator = 'authenticator:oauth2ohc';
  var authorizer = 'authorizer:oauth2ohc';
  ...
  ENV['ember-simple-auth'] = {
    ...
    //crossOriginWhitelist: [backendUrl],
    routeAfterAuthentication: '/',
    authenticationRoute: 'login',

    // Собственные настройки для облегчения конфигурирования
